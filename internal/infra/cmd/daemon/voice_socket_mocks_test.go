...
//
//	mockgen -package=cmd -destination=voice_socket_mocks_test.go github.com/partyzanex/a2text/internal/usecases/voice Recorder,Transcriber,Output
//
...
import (
	...
	voice "github.com/partyzanex/a2text/internal/usecases/voice"
...
func (m *MockRecorder) RecordToFile(ctx context.Context, opts voice.RecordOptions) (string, error) {
	m.ctrl.T.Helper()
